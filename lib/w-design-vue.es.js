...
var WModal = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-200001a6"]]);
WModal.install = (app) => {
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$6, [
        ...
        __props.pagination ? (openBlock(), createBlock(unref(_sfc_main$b), mergeProps({ key: 0 }, { ...__props.pagination, locale: __props.locale }, {
          onPageSizeChange,
