...
function updatePosition() {
  ...
  const triangleSize = Number(getComputedStyle(tooltipRef.value).getPropertyValue('--arrow-size').replace('px', ''))
...
<template>
  ...
  <teleport v-if="appendToBody" to="body">
    <transition :name="transition">
      <div v-show="visible" ref="tooltipRef" :class="tooltipClass" :style="tooltipStyle" @mouseenter="handleMouseEnter"
