<template>
  ...
  <w-grid class="grid-list">
    <w-grid-item v-for="item in 12" :key="item" span="1">
      <div class="rectangle"></div>
    </w-grid-item>
    <w-grid-item v-for="item in 6" :key="item" span="2">
      <div class="rectangle"></div>
    </w-grid-item>
    <w-grid-item v-for="item in 4" :key="item" span="3">
      <div class="rectangle"></div>
    </w-grid-item>
    <w-grid-item v-for="item in 3" :key="item" span="4">
      <div class="rectangle"></div>
    </w-grid-item>
    <w-grid-item v-for="item in 2" :key="item" span="6">
      <div class="rectangle"></div>
    </w-grid-item>
