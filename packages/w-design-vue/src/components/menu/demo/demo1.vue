<template>
  <w-preview title="Default" desc="Default">
    <w-space>
      <w-menu default-value="1" @select="onSelect" style="width: 240px">
        <w-menu-item label="default"></w-menu-item>
        <w-menu-item icon="moon" label="test 01"></w-menu-item>
        <w-menu-item icon="sun" label="test 02"></w-menu-item>
        <w-menu-item icon="file" label="test 02">
          <template #end>
            <w-chip size="small" type="danger">new</w-chip>
          </template>
        </w-menu-item>
      </w-menu>
    </w-space>
  ...
  <w-preview title="Menu Item Group" desc="Menu Item Group">
    <w-space>
      <w-menu default-value="1" style="width: 240px">
